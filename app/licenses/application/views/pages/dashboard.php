...
<article class="message is-primary has-shadow2">
  <div class="message-header">
    <p>Activity (Past 24 hours) <small class="tooltip is-tooltip-multiline is-tooltip-right " data-tooltip="Activites done by you will be marked with an ' done by user ' text, all other activities are done by the System, Cron Job or the Internal API."><i class="fas fa-question-circle"></i></small></p><a href="<?php echo base_url(); ?>activities" class="button is-small is-rounded is-white is-pulled-right">View All</a>
  </div>
