  ...
  <div class="container is-fluid">
    ...
    <div id="navMenuDocumentation" class="navbar-menu">
      ...
      <div class="navbar-item has-dropdown is-hoverable">
        ...
        <div id="moreDropdown" class="navbar-dropdown">  
        <a class="navbar-item " href="<?php echo base_url(); ?>generate_external" title="Generate client/external helper file for adding license check, update check and downloads etc in your own product.">
            <span>
              <strong>Client Helper File</strong>               
            </span>
          </a>         
          <a class="navbar-item " href="<?php echo base_url(); ?>generate_internal" title="Generate internal helper file for adding ability to add license, manage licenses etc to your order management system or some other system.">
            <span>
