     ...
     <div class="box">
      <div class="content">
        ...
        <div class="field">
          ...
          <div class="select">
            <select name="period" aria-describedby="verification_period_here" value="<?php echo set_value('period'); ?>">
     ...
     <div class="box">
      <div class="content">
        <div class="field">
          ...
          <textarea class="textarea" name="generated_code" placeholder="Code will be generated here, once the code is generated copy it and just follow the instructions from the documentation." rows="12"><?php if(!empty($generated_code)){echo $generated_code; }?></textarea>
        </div>
      </div>
    </div>
  </div>
