...
<input class="is-checkradio is-danger" type="checkbox" name="failed_update_download_logs" id="failed_update_download_logs" checked>
  ...
  <?php endif; ?>
  <label for="failed_update_download_logs" style="margin-left: 0px !important;">Add entries for failed update download attempts? <small class="tooltip is-tooltip-multiline is-tooltip-left" data-tooltip="Checking it will allow recording/adding of failed update download attempts, if unchecked failed attempts will be only visible in activity logs and not on update download page."><i class="fas fa-question-circle"></i></small></label>
  </div>
    <div class="field">
