  ...
  @chmod($config_file_sample,0777);
	...
	<div class="container main_body"> <div class="section" >
		...
		<div class="column is-6 is-offset-3">
			<center><h1 class="title p-t-lg p-b-lg m-b-sm" style="margin-right: -5px;
margin-left: -5px;">
...
?>
<div class='notification is-danger'>Database file (<strong><?php echo $db_file; ?></strong>) is not writable, you should change the file permission first then retry this step or you can change db settings yourself.</div>
...
?>
<div class='notification is-danger'>Configuration file (<strong><?php echo $config_file; ?></strong>) is not writable, you should change the file permission first then retry this step or you can change config settings yourself.</div>
